...
public class RedisJdbcMethod {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Создание Properties для аутентификации
            ...
            try {
                ...
                try {
                    ...
                    setStmt.setString(2, "world from Redis JDBC No Clean Method!");
            ...
            // Test with TTL
            try {
                statement.executeUpdate("SETEX jdbc:temp-key 60 'JDBC No clean method - expires in 60 seconds'");
